...
template<typename T>
static void _CDECL_ quick_sort(T* unsorted_array, int start, int size, sort_format sort_t) {
...
static void _CDECL_ quick_sort(T<V>& unsorted_array, int start, int size, sort_format sort_t) {
   using namespace Internal;
   quick_sort_helper(unsorted_array, start, size - 1, sort_t);
}
...
// Internals that must not be touched!!
namespace Internal {

template<typename T>
static void _CDECL_ quick_sort_helper(T* unsorted_array, int start, int end, sort_format sort_t) {
   if (start < end) {
...
template<typename T>
static int _CDECL_ partition(T* unsorted_array, int start, int end, sort_format sort_t) {
...
template<template<typename> class T, typename V>
static void _CDECL_ quick_sort_helper(T<V>& unsorted_array, int start, int end, sort_format sort_t) {
   if (start < end) {
      int pivot = partition(unsorted_array, start, end, sort_t);
      quick_sort_helper(unsorted_array, start, pivot - 1, sort_t);
      quick_sort_helper(unsorted_array, pivot + 1, end, sort_t);
...
template<template<typename> class T, typename V>
static int _CDECL_ partition(T<V>& unsorted_array, int start, int end, sort_format sort_t) {
   int pivot_index = choose_pivot(start, end);
